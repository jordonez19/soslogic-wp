...
public function crete_remove_footer_admin () {
	...
	public function crete_login_logo() { ?>
		...
		$adminlogo= $crete_options['admin_logo']['url'];
		$loginbgtype= $crete_options['admin_login_bg_type'];
		$loginbgimage= $crete_options['admin_login_bg']['url'];
		
		
		$loginbuttoncolor= $crete_options['login_button_admin'];
		$loginbuttontxtcolor= $crete_options['login_button_admin_txt'];
		$loginbuttoncolorhvr= $crete_options['login_button_admin_hvr'];
		$loginbuttontxtcolorhvr= $crete_options['login_button_admin_txt_hvr'];

		$overlaycolor= $crete_options['admin_overlay_color'];
		$mainbgcolor= $crete_options['admin_login_bg_color'];

		$customcode= $crete_options['admin_login_custom_code_setting'];

		$adminboxbgcolor = $crete_options['admin_login_box_color'];
		$adminboxbgradiustop = $crete_options['admin_login_box_radius']['top'];
		$adminboxbgradiusrght = $crete_options['admin_login_box_radius']['right'];
		$adminboxbgradiusbtm = $crete_options['admin_login_box_radius']['bottom'];
		$adminboxbgradiusleft = $crete_options['admin_login_box_radius']['left'];
		
		$adminboxbgradiusunit = $crete_options['admin_login_box_radius']['unit'];

		$textcolor = $crete_options['admin_login_box_text_color'];
		
		$admin_fields_color = $crete_options['admin_input_fields_color'];
		$admin_login_style = $crete_options['admin_login_style'];



		$adminbtnbgradiustop = $crete_options['admin_login_button_radius']['top'];
		$adminbtnbgradiusrght = $crete_options['admin_login_button_radius']['right'];
		$adminbtnbgradiusbtm = $crete_options['admin_login_button_radius']['bottom'];
		$adminbtnbgradiusleft = $crete_options['admin_login_button_radius']['left'];
		
		$adminbtnbgradiusunit = $crete_options['admin_login_button_radius']['unit'];
		
		
		$inpuftop = $crete_options['admin_input_field_radius']['top'];
		$inpufrght = $crete_options['admin_input_field_radius']['right'];
		$inpufsbtm = $crete_options['admin_input_field_radius']['bottom'];
		$inpufleft = $crete_options['admin_input_field_radius']['left'];
		
		$inpufunit = $crete_options['admin_input_field_radius']['unit'];
